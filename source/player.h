...
public:
    ...
    void setTrace(std::string player) {this->trace = player;}
    std::string getTrace() const {return this->trace;}
...
protected:
	...
	bool getBlessing(int32_t blessId) const {return blessMap[blessId];}
	/*double getBlessPercent();*/
